-- Migration cho Railway DB (MySQL)
-- Chạy file này nếu DB thiếu các cột/column mới cho game multiplayer
-- ============================================================================

-- 1. Thêm cột started_at còn thiếu vào GAME_ROOMS
--    (paused_at, ended_at, question_ids đã có từ import trước)
ALTER TABLE GAME_ROOMS ADD COLUMN started_at TIMESTAMP NULL;

-- 2. GAME_QUESTIONS, GAME_ANSWERS, GAME_PARTICIPANTS.is_ready, GAMES kanji
--    đã có từ import trước.
--
-- 3. Nếu cần seed câu hỏi, chạy riêng phần INSERT từ file 03_game_multiplayer.sql
