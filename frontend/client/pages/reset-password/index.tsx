...
export default function Index() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : t("auth.resetPassword.errorDefault"));
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="relative z-10 flex flex-col h-full px-10 lg:px-[60px] py-12 md:py-14">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col gap-2">
              <p className="text-[#94A3B8] text-base">{t("auth.login.welcomeDesc")}</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-end items-center gap-4 px-8 py-5">
          ...
          <button
            ...
            className={`text-xs font-bold transition-colors ${
              currentLang.startsWith("vi") ? "text-[#10B981]" : "text-[#94A3B8]"
            }`}
          >
            TIẾNG VIỆT
          </button>
          <button
            ...
            className={`text-xs font-bold transition-colors ${
              currentLang.startsWith("ja") ? "text-[#10B981]" : "text-[#94A3B8]"
            }`}
          >
            TIẾNG NHẬT
          </button>
