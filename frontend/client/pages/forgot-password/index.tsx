...
export default function Index() {
  ...
  return (
    <div className="flex min-h-screen bg-[#FCF8FA] font-inter">
      {/* Left Panel */}
      ...
      <div className="flex flex-1 md:w-1/2 flex-col justify-center items-start px-8 md:px-24 py-16 bg-white relative min-h-screen">
        <div className="w-full max-w-[448px] mx-auto flex flex-col gap-12">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-10">
            ...
            >
              {loading ? t("auth.forgotPassword.submitting") : step === "email" ? t("auth.forgotPassword.submit") : t("auth.forgotPassword.submitOtp")}
            </button>
          </form>
